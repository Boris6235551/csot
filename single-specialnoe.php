			...
			<div class="">
				...
				<div class="container">
					...
					<div class="tekhnicheskie-harakteristiki">
						...
						<div class="d-flex justify-content-center technical_parameters">
							<img src="<?php the_field('foto_gabaritov_izdeliya'); ?>" width="300" height="200" alt="" />
						</div>
					...
					<div class="row d-flex opisanie_pdf">
						<a href="<?php the_field('pdf1'); ?>" class="pdf_1 col-3 col-sm-2 col-md-2 col-lg-2 col-xl-2" ><i class="fa fa-file-pdf-o fa-3x" aria-hidden="true"></i><br>PDF1</a>
